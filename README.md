...
- Implementing our own interface: [Shape interface example](./src/main/java/lesson4/ShapeInterface.java)
- Using Java's ready-made interfaces: [Comparable interface](./src/main/java/lesson4/SortingStudents.java)
