...
class CalculatorTest {
    ...
    void testDivisionByZero() {
        // NOTE: () -> calculator.divide(6, 0) -syntax is a lambda expression
        // representing a Runnable
    ...
    void testAdditionToShowAllAssertions() {
        ...
        assertSame(calculator, calculator); // assert that they are the same object, a bit artificial example here with
                                            // calculator compared to itself
    ...
    /*
     * TODO: test the following cases with factorial:
     * 1. Factorial of a negative number is 1
     * 2. Factorial of zero is 1
     * 3. Factorial of 1 is 1
     * 4. Factorial of a larger number is correct, e.g. factorial(4) = 24
     */
}
