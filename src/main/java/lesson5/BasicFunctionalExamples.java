...
public class BasicFunctionalExamples {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> evenNumbers = numbers.stream()
                .filter(n -> n % 2 == 0)
                .collect(Collectors.toList()); // Stream must be "collected", in order it to be "executed", that is evaluated
        
        System.out.println("Even numbers: " + evenNumbers);

        // Example 3. Using a stream and labmda function to transform each number into its square
